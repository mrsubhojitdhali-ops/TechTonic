    ...
    return (
      <div style={{maxWidth:500, margin:'auto', padding:20, textAlign:'center', fontFamily:'sans-serif'}}>
        <div style={{border:'3px solid #dc2626', borderRadius:20, padding:25, background:'#fef2f2'}}>
          ...
          <h1 style={{color:'#dc2626'}}>{error.toUpperCase().includes('EXPIRED') ? 'EXPIRED' : 'NOT VALID'}</h1>
          <p>Certificate: <b>{effectiveId}</b></p>
          <p style={{fontSize:12, background:'white', padding:10, borderRadius:10}}>{error || 'This certificate is not currently valid.'}</p>
        </div>
    ...
    return (
      <div style={{maxWidth:500, margin:'auto', padding:20, textAlign:'center', fontFamily:'sans-serif'}}>
        <div style={{border:'3px solid #16a34a', borderRadius:20, padding:25, background:'#f0fdf4'}}>
          ...
          <p style={{fontSize:12, color:'green', fontWeight:'bold'}}>Live certificate status checked ✓</p>
